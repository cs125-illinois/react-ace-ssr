...
const AceSSR: React.FC<AceSSRProps> = ({
  id,
  theme,
  mode,
  value,
    ...
    return (
      <div id={ssrID}>
        ...
        <div
          ...
          className={editorElement.className.trim()}
  ...
  const serverContent = useRef<string | undefined>(document.getElementById(ssrID)?.innerHTML)
